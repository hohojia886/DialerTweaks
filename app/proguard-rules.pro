...
-keep class io.github.hohojia886.dialertweaks.MainHook { *; }

# Keep Provider and Utils for stable IPC
-keep class io.github.hohojia886.dialertweaks.providers.** { *; }
-keep class io.github.hohojia886.dialertweaks.utils.** { *; }

# Keep BuildConfig to avoid issues with product flavor checks
-keep class io.github.hohojia886.dialertweaks.BuildConfig { *; }
